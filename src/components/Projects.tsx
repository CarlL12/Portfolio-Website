        ...
        <div className="project-card">
          ...
          <div className="text">
            ...
            <p>
              ...
              of the project, we developed a Backoffice system for managing
              users, courses, and other administrative tasks. One of the most
              exciting parts was implementing a chat function with SignalR,
              enabling real time communication between app users and
              administrators in the Backoffice for support.
            </p>
            <p>
              This project gave us hands-on experience with modern technologies
              and showed us how backend systems and cloud services like Azure
              can work together to create scalable and efficient solutions.
            </p>
